...
class AudiosetDataset(Dataset):
    def __init__(self, audio_df, audio_conf, target_sample_rate=None):
        """
        ...
        self.data = audio_df["file_path"]
        self.labels = audio_df["label"]
    ...
    def _wav2fbank(self, filename, filename2=None):
        # mixup
        if filename2 == None:
            waveform, sr = torchaudio.load(filename) # type: ignore 
            waveform = waveform - waveform.mean()
        # mixup
        else:
            waveform1, sr = torchaudio.load(filename) # type: ignore 
            waveform2, _ = torchaudio.load(filename2) # type: ignore 
    ...
    def __getitem__(self, index):
        ...
        # if not do mixup
            ...
            fbank, mix_lambda = self._wav2fbank(filename)            
        ...
        return fbank, torch.tensor(self.labels[index]).float()
